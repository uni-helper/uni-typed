...
如果你正在使用 Vue 2、需要组件 TypeScript 类型支持，请使用 Volar v2.0.21 和 @uni-helper/uni-app-types、@uni-helper/uni-cloud-types 和 @uni-helper/uni-ui-types v0.5，这是最后已知可用的版本组合。
