...
<div style="display: flex; justify-content: center; align-items: center; gap: 8px;">
  ...
  <a href="https://www.npmjs.com/package/@uni-helper/uni-ui-components">
    <img src="https://img.shields.io/npm/v/%40uni-helper%2Funi-ui-components?style=for-the-badge" alt="npm" />
  </a>
  <a href="https://www.npmjs.com/package/@uni-helper/uni-ui-components">
    <img src="https://img.shields.io/npm/dm/%40uni-helper%2Funi-ui-components?style=for-the-badge" alt="npm downloads" />
  </a>
</div>
<div style="display: flex; justify-content: center; align-items: center; gap: 8px;">
...
这个包是 `@uni-helper/uni-typed` 项目的一部分，将 uni-ui 组件包装为可导入的 Vue v3 组件，并提供对应的 TypeScript 实例类型，请 [👉 查看 Netlify 文档](https://uni-typed.netlify.app/) 或 [👉 查看 Cloudflare 文档](https://uni-typed.pages.dev/) 了解具体用法和示例。
