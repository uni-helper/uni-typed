...
这个包是 `@uni-helper/typed` 项目的一部分，为 Vue v3 uni-app、uni-cloud 和 uni-ui 组件提供 TypeScript 类型。
...
请查看 [源代码](https://github.com/uni-helper/typed/tree/main/packages/uni-types/src) 了解所有类型。
